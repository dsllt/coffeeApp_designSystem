...
import {
  ProfilePersonalReviewBox,
  ProfilePersonalReviewBoxProps,
} from '@poacoffee/react'

export default {
  title: 'Data display/Profile Personal Review Box',
  tags: ['autodocs'],
  component: ProfilePersonalReviewBox,
  args: {
    imgSrc:
...
} as Meta<ProfilePersonalReviewBoxProps>

export const Primary: StoryObj<ProfilePersonalReviewBoxProps> = {}
